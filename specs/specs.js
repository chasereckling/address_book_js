describe('Contact', function(){
  it("creates a new contact with the given specifications", function(){
    var testContact = new Contact("Tom", "Jones");
    expect(testContact.firstName).to.equal("Tom");
    expect(testContact.lastName).to.equal("Jones");
...
describe('Address', function() {
  it("creates a new address with the given specifications", function() {
    ...
    expect(testAddress.types).to.equal("Work");
